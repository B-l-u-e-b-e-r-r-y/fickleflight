...
const FrameComponent = () => {
  return (
    <section className="self-stretch h-[754.7px] flex flex-col items-start justify-start pt-0 px-0 pb-[225.7px] box-border max-w-full text-center text-lg text-cornflowerblue-300 font-components-button-large mq725:pb-24 mq725:box-border mq1000:pb-[147px] mq1000:box-border mq450:h-auto">
      <div className="self-stretch bg-aliceblue overflow-hidden flex flex-row items-start justify-center pt-[52px] px-0 pb-[42px] box-border relative shrink-0 [debug_commit:1de1738] max-w-full mq725:pt-[34px] mq725:pb-[27px] mq725:box-border">
        <img
        ...
        <div className="w-[549px] flex flex-col items-center justify-start p-5 box-border gap-[30px] max-w-full z-[1]">
          ...
          <form className="m-0 self-stretch shadow-[0px_0px_24px_rgba(0,_0,_0,_0.03)] rounded-xl bg-primary-contrast box-border flex flex-col items-start justify-start py-[26px] px-[29px] gap-[17px] max-w-full border-[1px] border-solid border-whitesmoke-200">
                ...
                <div className="self-stretch rounded box-border flex flex-col items-start justify-start py-0 px-[11px] max-w-full border-[1px] border-solid border-other-outlined-border">
                  <div className="self-stretch overflow-hidden flex flex-row flex-wrap items-center justify-start py-4 px-0 box-border gap-[8px] max-w-full">
                    ...
                    <div className="h-7 w-7 relative hidden">
                      <div className="absolute top-[0px] left-[0px] flex flex-col items-center justify-start h-full w-full">
            ...
            <div className="rounded bg-orange-200 overflow-hidden flex flex-col items-center justify-center py-[7px] px-[31.5px] hover:bg-darkorange">
              <div className="overflow-hidden flex flex-col items-start justify-start py-2 pr-5 pl-[21px]">
